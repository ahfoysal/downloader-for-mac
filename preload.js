...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  importLocalFile: (filepath, copy) => ipcRenderer.invoke('import-local-file', { filepath, copy }),
  ...
  onOpenUrlNewTab: (cb) => ipcRenderer.on('open-url-new-tab', (_e, url) => cb(url)),
  browseCreateTab: (url) => ipcRenderer.invoke('browse-create-tab', url),
  browseCloseTab: (id) => ipcRenderer.invoke('browse-close-tab', id),
  browseSwitchTab: (id) => ipcRenderer.invoke('browse-switch-tab', id),
  browseNavigate: (id, url) => ipcRenderer.invoke('browse-navigate', { id, url }),
  browseBack: () => ipcRenderer.invoke('browse-back'),
  browseForward: () => ipcRenderer.invoke('browse-forward'),
  browseReload: () => ipcRenderer.invoke('browse-reload'),
  browseSetBounds: (bounds) => ipcRenderer.invoke('browse-set-bounds', bounds),
  browseSetVisible: (v) => ipcRenderer.invoke('browse-set-visible', v),
  browseGetTabs: () => ipcRenderer.invoke('browse-get-tabs'),
  browseCurrentUrl: () => ipcRenderer.invoke('browse-current-url'),
  onBrowseTabs: (cb) => ipcRenderer.on('browse-tabs', (_e, data) => cb(data)),
